...
import {DataDaoType} from 'app/repository/services/dao/data/data-dao';
...
export class TypeActions {
  @Input() type: DataDaoType;

  updateState = new BehaviorSubject<UpdateState>('not-updating');

  constructor(private updater: Updater, public remover: Remover, private activeStore: ActiveStore) {
  }
  ...
  remove() {
    this.remover.removeData(this.activeStore.activeData, this.type);
  }
}
